...
import com.test.hippy.domain.Authority;
import com.test.hippy.domain.PersistentToken;
import com.test.hippy.domain.User;
import com.test.hippy.repository.PersistentTokenRepository;
import com.test.hippy.repository.UserRepository;
import com.test.hippy.security.SecurityUtils;
import com.test.hippy.service.MailService;
import com.test.hippy.service.UserService;
import com.test.hippy.web.rest.dto.UserDTO;
...
public class AccountResource {
	...
	public ResponseEntity<?> registerAccount(@Valid @RequestBody UserDTO userDTO, HttpServletRequest request) {
		...
		if (user != null) {
			...
			user = userService.createUserInformation(userDTO.getLogin(), userDTO.getPassword(), userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail().toLowerCase(), userDTO.getLangKey());
	...
	public ResponseEntity<UserDTO> getAccount() {
		...
		return new ResponseEntity<>(new UserDTO(user.getLogin(), null, user.getFirstName(), user.getLastName(), user.getEmail(), user.getLangKey(), roles), HttpStatus.OK);
	}
